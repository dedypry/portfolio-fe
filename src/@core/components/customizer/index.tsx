      ...
      >
        ...
        <div className={styles.header}>
          ...
          <div className='flex gap-4'>
            <div className='relative flex cursor-pointer' onClick={resetSettings}>
        ...
        >
          <div className={styles.customizerBody}>
            <div className='flex flex-col gap-6'>
              <Chip className='self-start rounded-sm' color='primary' label='Theming' size='small' variant='tonal' />
                  ...
                  >
                    {({ TransitionProps }) => (
                      <Fade {...TransitionProps} style={{ transformOrigin: 'right top' }}>
                        <Paper className={styles.colorPopup} elevation={6}>
            ...
            <div className='flex flex-col gap-6'>
              <Chip className='self-start rounded-sm' color='primary' label='Layout' size='small' variant='tonal' />
              <div className='flex flex-col gap-2'>
